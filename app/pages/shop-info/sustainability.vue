  ...
  <div class="container mx-auto px-4 py-12">
    <div v-if="page" class="max-w-4xl mx-auto">
      ...
      <header class="text-center mb-16">
        <h1 class="text-5xl font-bold mb-6 text-gray-900 dark:text-white">Sustainability</h1>
        <p class="text-xl text-gray-600 dark:text-gray-400">Our commitment to environmental responsibility</p>
      </header>
...
const { data: page, pending, error } = await useFetch('https://woo.groovygallerydesigns.com/wp-json/wp/v2/pages/8376', {
  headers: {
